...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <div style="padding-left: 50px;">
        <div>
            <div style="padding: 10px;">
                ...
                <div style="width: 85%; float: left; padding-left: 10px;">
                    <asp:HyperLink ID="HlkUsers" runat="server" style="font-size:15px" NavigateUrl="~/modules/nguoi_dung/danhsachnguoidung.aspx">Người dùng</asp:HyperLink>
                    <br />
        ...
        <div>
            <div style="padding: 10px;">
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Styles/Images/user_group_authorization.png" Style="float: left;
                    height: 62px; width: 50px" />
                <div style="width: 85%; float: left; padding-left: 10px;">
                    <asp:HyperLink ID="HyperLink1" runat="server" style="font-size:15px" NavigateUrl="~/modules/nguoi_dung/nhomnguoidung.aspx">Phân quyền</asp:HyperLink>
                    <br />
