<%@ Page Title="" Language="C#" MasterPageFile="~/modules/Site.Master" AutoEventWireup="true"
    CodeBehind="danhgiahanhkiemhocsinh.aspx.cs" Inherits="SoLienLacTrucTuyen_WebRole.Modules.StudentConductModifyPage" %>
    ...
    <div id="divSearch">
        <div id="divSearchCriteria">
            <asp:UpdatePanel ID="UPDropdownlists" runat="server">
                <ContentTemplate>
                    <table class="search" style="font-weight: bold">
                        <tr>
                            <td>
                                Năm học:
                            </td>
                            <td style="width: 180px;">
                                <asp:Label ID="LblYearName" runat="server" Width="150px"></asp:Label>                                
                            </td>
                            <td>
                                Lớp:
                            </td>
                            <td style="width: 180px">
                                <asp:Label ID="LblClassName" runat="server" Width="150px"></asp:Label>
                            </td>
                            <td>
                                Học kỳ:
                            </td>
                            <td>
                                <asp:Label ID="LblTermName" runat="server" Width="150px"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
