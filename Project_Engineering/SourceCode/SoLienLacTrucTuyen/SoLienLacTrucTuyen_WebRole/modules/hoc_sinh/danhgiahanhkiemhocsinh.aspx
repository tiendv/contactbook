<%@ Page Title="" Language="C#" MasterPageFile="~/modules/Site.Master" AutoEventWireup="true"
    CodeBehind="danhgiahanhkiemhocsinh.aspx.cs" Inherits="SoLienLacTrucTuyen_WebRole.Modules.ModifyStudentConductPage" %>
            ...
            <asp:Repeater ID="RptHanhKiemHocSinh" runat="server" OnItemDataBound="RptHanhKiemHocSinh_ItemDataBound">
                <ItemTemplate>
                    <tr class='<%#((Container.ItemIndex + 1) % 2 == 0) ? "oddRow" : "evenRow"%>'>
                        ...
                        <td>
                            Tổng cộng: <%#DataBinder.Eval(Container.DataItem, "TotalOfAbsentDays")%>
                            <span style='<%#((int)DataBinder.Eval(Container.DataItem, "TotalOfAbsentDays") != 0) ? "" : "display:none"%>'>
                            , có phép: <%#DataBinder.Eval(Container.DataItem, "TotalOfAskedAbsentDays")%>
                            , không phép: <%#DataBinder.Eval(Container.DataItem, "TotalOfUnaskedAbsentDays")%>
                            </span>
                        </td>
