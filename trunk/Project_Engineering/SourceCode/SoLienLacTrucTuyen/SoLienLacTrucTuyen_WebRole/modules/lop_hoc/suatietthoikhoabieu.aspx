<%@ Page Title="" Language="C#" MasterPageFile="~/modules/Site.Master" AutoEventWireup="true"
    CodeBehind="suatietthoikhoabieu.aspx.cs" Inherits="SoLienLacTrucTuyen_WebRole.Modules.SuaTietThoiKhoaBieuPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    ...
    <div style="width: 500px; padding: 10px;" class="loginBox ui-corner-all">
        <table>
            ...
            <tr style="height: 27px">
                ...
                <td>
                    <asp:Label ID="LblMonHoc" runat="server" Text="(Chưa xác định)"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:ImageButton ID="BtnAddItem" runat="server" OnClick="BtnOpenPopupMonHoc_Click"
                        ImageUrl="~/Styles/Icons/icon_edit.png" />
            ...
            <tr style="height: 27px">
                ...
                <td style="width: 300px">
                    <asp:Label ID="LblGiaoVien" runat="server" Text="(Chưa xác định)"></asp:Label>
                </td>
                <td>
    ...
    <div style="width: 170px; margin: 0px auto 0px auto; padding: 5px 0px 5px 0px">
        <asp:ImageButton ID="BtnSaveEdit" runat="server" ImageUrl="~/Styles/Images/button_save.png"
            OnClick="BtnSaveEdit_Click" ValidationGroup="EditTietHocTKB" CssClass="SaveButton" />&nbsp;
        <asp:ImageButton ID="BtnCancel" runat="server" ImageUrl="~/Styles/Images/button_cancel.png"
            OnClick="BtnCancelEdit_Click" CssClass="CancelButton" />
    </div>
</asp:Content>
