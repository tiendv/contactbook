        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="BtnSearch" runat="server" ImageUrl="~/Styles/Images/button_search_with_text.png"
                    ToolTip="Tìm kiếm học lực" OnClick="BtnSearch_Click" />
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <table class="repeater">
                    ...
                    <asp:Repeater ID="RptHocLuc" runat="server" OnItemCommand="RptHocLuc_ItemCommand"
                            ...
                            <tr id="RepeaterRow" runat="server" class='<%#((Container.ItemIndex + 1) % 2 == 0) ? "oddRow" : "evenRow"%>'>
                                ...
                                <td class="icon" style="height: 40px;">
                                    ...
                                    <asp:ImageButton ID="BtnEditItem" runat="server" ImageUrl="~/Styles/Images/button_edit.png"
                                        CommandName="CmdEditItem" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "LearningAptitudeId")%>' />
                                ...
                                <td class="icon" style="height: 40px;">
                                    ...
                                    <asp:ImageButton ID="BtnDeleteItem" runat="server" ImageUrl="~/Styles/Images/button_delete.png"
                                        CommandName="CmdDeleteItem" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "LearningAptitudeName")%>' />
                    ...
                    <table class="inputBorder" style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: auto;" colspan="4">
                                ...
                                <asp:Label ID="LblErrorLearningAptitudeNameThem" runat="server" Text="Tên học lực không được để trống"
                                ...
                                <asp:CustomValidator ID="LearningAptitudeNameValidatorAdd" runat="server" ControlToValidate="TxtLearningAptitudeNameThem"
                                    Display="Dynamic" ErrorMessage="Học lực đã tồn tại" ForeColor="Red" ValidationGroup="AddHanhKiem"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 70px; padding-right: 20px; float: right">
                                ...
                                <ajaxToolkit:MaskedEditExtender ID="MEE_TxtDTBTu" runat="server" TargetControlID="TxtDTBTuThem"
                                    MaskType="Number" Mask="9.9">
                                </ajaxToolkit:MaskedEditExtender>
                                <asp:Label ID="LblErrorDTBThem" runat="server" Text="Khoảng điểm trung bình không được để trống"
                                    CssClass="error hide_error">
                                </asp:Label>
                            </td>
                            <td style="width: 50px;">
                            ...
                            <td style="width: 70px; float: right; padding-right: 5px">
                                ...
                                <ajaxToolkit:MaskedEditExtender ID="MEE_TxtDTBDenThem" runat="server" TargetControlID="TxtDTBDenThem"
                                    MaskType="Number" Mask="9.9">
                                </ajaxToolkit:MaskedEditExtender>
                            </td>
                        </tr>
                    ...
                    <div class="inputBorder">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: auto;" colspan="4">
                                    <asp:TextBox ID="TxtSuaLearningAptitudeName" runat="server" CssClass="input_textbox"></asp:TextBox>
                                    <asp:Label ID="TxtErrorSuaLearningAptitudeName" runat="server" Text="Tên học lực không được để trống"
                                        ForeColor="red" Style="display: none;">
                                    </asp:Label>
                                    <asp:RequiredFieldValidator ID="LearningAptitudeNameRequiredEdit" runat="server"
                                        ControlToValidate="TxtLearningAptitudeNameThem" Display="Dynamic" ErrorMessage="Tên học lực không được để trống"
                                        ForeColor="Red" ValidationGroup="AddHanhKiem"></asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="LearningAptitudeNameValidatorEdit" runat="server" ControlToValidate="TxtLearningAptitudeNameThem"
                                        Display="Dynamic" ErrorMessage="Học lực đã tồn tại" ForeColor="Red" ValidationGroup="AddHanhKiem"></asp:CustomValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <%--                               <td style="width:auto;">
                                    <asp:TextBox ID="TxtMarkRatioHocLucSua" runat="server" CssClass="input_textbox" style="font-family:arial; text-align:right">
                                    </asp:TextBox>
                                    <ajaxToolkit:MaskedEditExtender ID="MEE_TxtMarkRatioHocLucSua" runat="server"
                                        TargetControlID="TxtMarkRatioHocLucSua"
                                        MaskType="Number"
                                        Mask="9">                                    
                                    </ajaxToolkit:MaskedEditExtender>                       
                                    <ajaxToolkit:TextBoxWatermarkExtender ID="TWTE_TxtMarkRatioHocLucSua" runat="server" 
                                        Enabled="True" TargetControlID="TxtMarkRatioHocLucSua"
                                        WatermarkText="Nhập số thập phân tròn chẵn"
                                        WatermarkCssClass="input_textbox textBoxWaterMask">
                                    </ajaxToolkit:TextBoxWatermarkExtender>
                                    <asp:Label ID="TxtErrorMarkRatioHocLucSua" runat="server" 
                                ...
                                <td style="width: 60px; padding-right: 10px; float: right">
                                    ...
                                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="TxtDTBTuSua"
                                        MaskType="Number" Mask="9.9">
                                    </ajaxToolkit:MaskedEditExtender>
                                    <asp:Label ID="Label18" runat="server" Text="Khoảng điểm trung bình không được để trống"
                                        CssClass="error hide_error">
                                    </asp:Label>
                                </td>
                                <td style="width: 50px;">
                                ...
                                <td style="width: 60px; float: right; padding-right: 10px">
                                    ...
                                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="TxtDTBDenSua"
                                        MaskType="Number" Mask="9.9">
                                    </ajaxToolkit:MaskedEditExtender>
                                </td>
                            </tr>
