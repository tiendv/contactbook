...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
    <asp:Panel ID="PnlError" runat="server" Style="width: 95%; padding: 10px 20px 10px 20px"
        class="loginBox ui-corner-all" Visible="false">
        Năm học hiện hành
        <asp:Label ID="LblExistedYearName" runat="server"></asp:Label>
        đã tồn tại. Quay lại
        <asp:HyperLink ID="HlkYears" runat="server" NavigateUrl="~/modules/danh_muc/danhmucnamhoc.aspx">danh sách năm học</asp:HyperLink>
    </asp:Panel>
