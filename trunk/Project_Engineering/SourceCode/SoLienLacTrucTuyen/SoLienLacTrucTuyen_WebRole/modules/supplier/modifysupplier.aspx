<%@ Page Title="" Language="C#" MasterPageFile="~/modules/Site.Master" AutoEventWireup="true"
    CodeBehind="modifysupplier.aspx.cs" Inherits="SoLienLacTrucTuyen_WebRole.Modules.ModifySchoolPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="server">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:RequiredFieldValidator ID="SchoolNameRequired" runat="server" Display="Dynamic"
                    ValidationGroup="ModifySchool" ForeColor="Red" ControlToValidate="TxtSchoolName"
                ...
                <asp:CustomValidator ID="SchoolNameCustomValidator" runat="server" ErrorMessage="Đã tồn tại tên trường này ở tỉnh/thành, huyện/quận đã chọn"
                    ValidationGroup="ModifySchool" Display="Dynamic" ControlToValidate="TxtSchoolName"
                    ForeColor="Red">
                </asp:CustomValidator>
            </td>
            ...
            <td rowspan="3" style="width: 150px; height: 27px; padding: 0px 10px 0px 10px;">
                ...
                <asp:ImageButton ID="BtnUpload" runat="server" ImageUrl="~/Styles/buttons/button_upload.png"
                    OnClick="BtnUpload_Click" CssClass="UploadButton" ValidationGroup="ModifySchool" />
            </td>
        </tr>
        <tr>
    ...
    <div style="width: 170px; margin: 0px auto 0px auto; padding: 5px 0px 5px 0px">
        <asp:ImageButton ID="BtnSave" runat="server" ImageUrl="~/Styles/buttons/button_save.png"
            OnClick="BtnSave_Click" ValidationGroup="ModifySchool" CssClass="SaveButton" />&nbsp;
