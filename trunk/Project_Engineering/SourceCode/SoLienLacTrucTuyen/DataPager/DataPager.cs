...
namespace SoLienLacTrucTuyen.DataPager
{
    public class DataPager : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        {
            object[] objState = new object[4];
            objState[0] = CurrentIndex;
            objState[1] = PageSize;
            objState[2] = PageCount;
            objState[3] = ItemCount;
            return objState;
        }
        ...
        protected override void LoadControlState(object state)
        {
            ...
            PageCount = (int)savedState[2];
            ItemCount = (double)savedState[3];
        }
        #endregion
        ...
        /// </summary>
        private int _firstCompactedPageCount = 3;
        [Category("Behavioural")]
        ...
        /// </summary>
        private string _SHOW_RESULT = "Hiển thị kết quả";
        [Category("Globalization")]
        ...
        /// </summary>
        private string _BACK_TO_FIRST = "Trở về trang đầu";
        [Category("Globalization")]
        ...
        /// </summary>
        private string _GO_TO_LAST = "Đến trang cuối";
        [Category("Globalization")]
        ...
        /// </summary>
        private string _BACK_TO_PAGE = "Trở về trang";
        [Category("Globalization")]
        ...
        /// </summary>
        private string _NEXT_TO_PAGE = "Đến trang";
        [Category("Globalization")]
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (GeneratePagerInfoSection)
            {
                ...
                writer.Write("<b>" + PageClause + "</b> " + CurrentIndex.ToString() + "" + OfClause + "" + PageCount.ToString() + "&nbsp;");
                writer.RenderEndTag();
            }
