                                        ...
                                        <tr id="RepeaterRow" runat="server">
                                            ...
                                            <td style="height: 40px; width: 33%">
                                                ...
                                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Styles/Images/button_edit.png"
                                                    CommandName="CmdChooseSubject" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "SubjectId")%>' />
                                            ...
                                            <td style="height: 40px; width: 33%">
                                                ...
                                                <asp:ImageButton ID="BtnFakedTeacherItem" runat="server" Style="display: none;" />
                                                <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Styles/Images/button_edit.png"
                                                    CommandName="CmdChooseTeacher" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "TeacherName")%>' />
                                                <ajaxToolkit:ModalPopupExtender ID="MPETeacher" runat="server" TargetControlID="BtnFakedTeacherItem"
